...
<article id="post-<?php the_ID(); ?>" <?php post_class('col-md-12 col-sm-12 grid'); ?>>
		...
		<div class="featured-thumb col-md-4 col-sm-4">
			<?php if (has_post_thumbnail()) : ?>	
				<a href="<?php the_permalink() ?>" title="<?php the_title() ?>"><?php the_post_thumbnail('murray-pop-thumb'); ?></a>
			<?php else: ?>
		...
		<div class="out-thumb col-md-8 col-sm-8">
			<header class="entry-header">
				...
				<span class="readmore"><a class="hvr-underline-from-center" href="<?php the_permalink() ?>"><?php _e('Read More','murray'); ?></a></span>
			</header><!-- .entry-header -->
		</div><!--.out-thumb-->
